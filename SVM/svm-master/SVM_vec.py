...
# 1.读取数据集
path = r'D:\POI2vec\SVM\node2vec_02\z10_1_1.csv'
...
# 3.训练svm分类器
classifier = svm.SVC(C=10, kernel='linear', gamma=1, decision_function_shape='ovo')  # ovr:一对多策略；
...
tra_flabel = open(r"D:\POI2vec\SVM\svm-master\group\zonecls_train.txt","w",encoding = "utf-8") #预测标签
...
tes_flabel = open(r"D:\POI2vec\SVM\svm-master\group\zonecls_test.txt","w",encoding = "utf-8") #预测标签
...
# tralabel = open(r"D:\POI2vec\SVM\svm-master\group\train_label.txt","w",encoding = "utf-8") #预测标签
...
# tralabel.close()
#
# teslabel = open(r"D:\POI2vec\SVM\svm-master\group\test_label.txt","w",encoding = "utf-8") #预测标签
# rule0=test_label
# for m in rule0:
#     n=int(m)
